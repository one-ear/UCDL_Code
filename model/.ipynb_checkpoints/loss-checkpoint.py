...
class InfoNCEGraph(nn.Module):
    def __init__(self, in_channels=128, out_channels=256, mem_size=256, positive_num=64, negative_num=128, T=1.6, class_num=4, label_all=[]):
        ...
        # self.label_all = np.array(label_all)
